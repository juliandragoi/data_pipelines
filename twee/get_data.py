...
def parse_args():
    ...
    parser.add_argument('--consumer_key', help='twee consumer_key', type=str, action='store')
    parser.add_argument('--consumer_secret', help='twee consumer_secret', type=str, action='store')
    parser.add_argument('--access_token', help='twee access_token', type=str , action='store')
    parser.add_argument('--access_secret', help='twee access_secret', type=str , action='store')
